...
- **Relatório**: gráficos de pizza compactos. O administrador vê o andamento por pessoa (tarefas e subtarefas, atrasos, próximos prazos); cada usuário vê o seu. Mostra dias de atraso, dias que faltam, maior atraso e o que vence em 7 dias. Visualizadores não têm essa aba.
